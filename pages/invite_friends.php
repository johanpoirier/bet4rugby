...
<div class="maincontent">
    <div class="ppp">
        ...
        <form method="post" name="IN" action="/?op=invite_friends">
            ...
            <div class="formfield"><b>Choisisser un ou plusieurs inscrits à rejoindre votre groupe '<?php echo $userTeam['name']; ?>'</b></div><br />
            <?php for ($i = 0; $i < 5; $i++) { ?>
                Inviter
            ...
            <?php } ?>
            <br /><br />
            <center><input class="image" type="image" src="/include/theme/<?php echo $config['template']; ?>/images/submit.gif" value="Valider"></center>
        </form>
        ...
        <form method="post" name="OUT"  action="/?op=invite_friends">
            ...
            <?php for ($i = 0; $i < 5; $i++) { ?>
                <input type="text" size="30" id="email_<?php echo $i; ?>" name="email_<?php echo $i; ?>" /> qui sera inscrit au groupe '<?php echo $userTeam['name']; ?>'
                <br />
                <br />
            <?php } ?>
            <br /><br />
